    ...
    <el-card class="!m-[3px] !p-[10px]">
      <el-descriptions :column="1">
        ...
        <el-descriptions-item label="博客链接"
          ><span v-copy="'https://echoblog.com.cn/'" class="!cursor-pointer">https://echoblog.com.cn/</span>
        </el-descriptions-item>
        <el-descriptions-item label="QQ">
          <span v-copy="'2483401419'" class="!cursor-pointer">2483401419</span>
        </el-descriptions-item>
        <el-descriptions-item>
          ...
          <el-card class="card-hover animate__animated animate__fadeIn">
            <div
              ...
              :style="{
                zIndex: 1,
                backgroundImage: `url(${
                  item.site_avatar || 'http://img.fbeer.cn/FgXljnZtGqu1va0eGvcArpqxaRqX'
                })`,
              }"
